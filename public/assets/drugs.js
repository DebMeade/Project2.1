...
$(document).ready(function () {
  ...
  $(".drugCheckMark").on("click", function(event) {
    ...
    $(function(){
      ...
      $(".modalApi").on("click", function (event ) {
            event.preventDefault()
  
  
            var drugName = $(this).parent().parent().children("td.drugName").text();
            console.log(drugName)
            
         var queryURL = "https://api.fda.gov/drug/label.json?search=openfda.brand_name:" + drugName;
  
        $.ajax({
          url: queryURL,
          type: "GET"
        }).then(function (results) {
           var precautionsModal = results.results[0].general_precautions;
           var instructionsModal = results.results[0].dosage_and_administration;
           
  
           $("#b").html("");
           $("#b").append(precautionsModal);
           $("#drugInstructions").html("");
           $("#drugInstructions").append("<p>" + instructionsModal + "</p>");
          ...
          // console.log("Drug Interactions: " + results.results[0].drug_interactions);
          // console.log("======================");
          console.log("Precautions: " + precautionsModal);
          // console.log("======================");
          // console.log("Adverse Reactions: " + results.results[0].adverse_reactions);
          // console.log("======================");
          // console.log("Ingredients: " + results.results[0].description);
